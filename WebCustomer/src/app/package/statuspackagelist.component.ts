...
@Component({
  selector: 'app-statuspackagelist',
  templateUrl: './statuspackagelist.component.html',
  styleUrls: ['./statuspackagelist.component.scss'],
})
export class StatuspackagelistComponent implements OnInit, OnDestroy {
  ...
  //   const dialogRef = this.dialog.open(StatepackageComponent, { width: '100vw', panelClass: 'my-class' });
  //   dialogRef.componentInstance.activityId = activityId;
  //   dialogRef.componentInstance.customerId = this.userId;
